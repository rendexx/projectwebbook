...
<div class="khung-mo-ta">
    ...
    <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <div class="row m-0 justify-content-between">
            ...
            <div class="col-2 p-0 align-self-center">
                <div class="text-wrapper text-justify mr-2">
                    <span class="don-gia font-weight-bold d-md-block d-none">
								<input id="price-{{$key}}" style="border: none; background: #fff;text-align: center;width: 40%;" type="text" disabled value="{{number_format($values->product_price)}}"><span>đ</span>
                    </span>
                    <span class="don-gia font-weight-bold d-block d-md-none">
								<input id="price-{{$key}}" style="border: none; background: #fff;text-align: center;width: 80%;" type="text" disabled value="{{number_format($values->product_price)}}"><span>đ</span>
                    </span>
                </div>
            </div>
            ...
            <!--mobile-->
            <!-- <div class="col-2 p-0 align-self-center d-flex justify-content-center d-md-none">
                <div class="text-justify">
                    <span onclick="minus({{$key}})" class="btn nut-giam mb-2 d-flex align-items-center"><i class="fa fa-minus align-self-center"></i></span>
                    <input id='amount-{{$key}}' name="amount" type="text" class="input-soluong" value="{{$values->product_amount}}" style="margin-top: -18px; margin-bottom: -18px;">
                    <span onclick="plus({{$key}})" class="btn nut-tang mt-2 d-flex align-items-center"><i class="fa fa-plus align-self-center"></i></span>
                </div>
            </div> -->

            <div class="col-2 p-0 align-self-center">
                <div class="text-wrapper text-justify d-md-block d-none">
                    <span class="don-gia font-weight-bold"><input id="total-{{$key}}"style="border: none; background: #fff;text-align: center;width: 40%;" type="text" disabled value="{{number_format($values->total_money)}}"><span>đ</span></span>
                </div>
                <div class="text-wrapper text-justify d-block d-md-none">
                    <span class="don-gia font-weight-bold"><input id="total-{{$key}}"style="border: none; background: #fff;text-align: center;width: 80%;" type="text" disabled value="{{number_format($values->total_money)}}"><span>đ</span></span>
                </div>
            </div>
            ...
            <div style="display: flex; justify-content: center;" class="col-2 align-self-center">
                <div class="text-wrapper">
                    ...
                    <a href="delete/{{$values->ma_SP}}" class="nut-xoa">Xóa</a>
    ...
    <div class="row m-0 justify-content-between">
        ...
        <div class="col-md-4 col-12 align-self-center p-0">
            <div class="text-wrapper text-justify">
                <span class="product">Tổng số sản phẩm: </span>
        ...
        <div class="col-md-4 col-12 align-self-center p-0">
            <div class="text-wrapper text-justify">
                <span class="price" style="font-weight: 500">Thành tiền:<input id="total" style="border: none; background: #fff;text-align: center;width: 62%;" type="text" disabled value="{{number_format($total)}}"><span>đ</span></span>
