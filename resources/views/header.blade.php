    ...
    <div class="row">
        <div class="col-md-12">
            <div class="menu pt-3 pb-3">
                <a href="{{url('/')}}" class="item-link pr-2" >Trang chủ</a>
                @guest
                ...
                @else
                    <li class="dropdown">
                        <div class="dropdown-toggle" data-toggle="dropdown">Xin chào <a href="" style="text-decoration: none"> <span class="namestyle">{{ Auth::user()->hoten }}</span> <b class="caret"></b></a></div>
                        <ul class="dropdown-menu">
                            <li>
                                <a class="" href="thong-tin-khach-hang/{{Auth::user()->name}}">Thông Tin Khách Hàng</a>
                            </li>
                            <li>
                                <a class="" href="{{url('bills')}}">Đơn hàng của bạn</a>
                            </li>
                            <li>
    ...
    <div class="row">
        <div class="col-md-3 d-md-block d-none">
            <div class="hinh-anh-logo">
                <a href="{{url('/')}}"><img src="public/images/hinh-anh-trang-chu/logosach1.png" alt="" class="pb-2"></a>
            </div>
        </div>
